...
for project_name in model_list:
    ...
    model.attractor.attractors_df.to_csv('/home/spankaew/Git/astrologics/models/attractor_group/' +project_name + '_attractors.csv')
...
for project_name in model_list:
    ...
    concatenated_columns.to_csv(path_to_file + project_name + '_attractor_group.csv', index = True)
...
attractor_counts.to_csv('/home/spankaew/Git/astrologics/models/attractor_counts.csv', index=True)
