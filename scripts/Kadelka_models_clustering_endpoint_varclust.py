...
for model_file in model_list:
    ...
    total_index_score = pd.concat([total_index_score, rand_index_score], axis=1, ignore_index = False)

# Rename the columns of the total_index_score DataFrame
total_index_score.columns = model_list
    
# Save the results
total_index_score.to_csv(path_to_results + "rand_index_endpointclustering_v3.csv")
