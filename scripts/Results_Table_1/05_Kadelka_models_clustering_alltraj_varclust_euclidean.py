...
def calculate_total_distancematrix(simulation_df):
    ...
    for i in tqdm(range(num_trajectories)):
        for j in range(num_trajectories):
            distance_matrix[i, j] = euclidean(pca_all_trajectory[i].flatten(), pca_all_trajectory[j].flatten())
...
# Save the results
total_index_score.to_csv(path_to_results + "rand_index_alltrajclustering_euclidean.csv")