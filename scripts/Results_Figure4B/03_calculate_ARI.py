...
simulation_list = ['Invasion_simulation_50.csv',
                   ...
                   'Invasion_simulation_500.csv', 
                   'Invasion_simulation_750.csv', 
                   'Invasion_simulation_1000.csv',
                   'Invasion_simulation_2500.csv',
                   'Invasion_simulation_5000.csv',
                   'Invasion_simulation_7500.csv',
...
total_index_score.columns = simulation_list
    
# Save the results
total_index_score.to_csv(path_to_results + "Invasion_rand_index_alltrajclustering_v2.csv")